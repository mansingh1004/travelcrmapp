...
_LeadDto _$LeadDtoFromJson(Map<String, dynamic> json) => _LeadDto(
  ...
  specialAssistanceRequired: json['specialAssistanceRequired'] as bool?,
  assistancePassengerCount: (json['assistancePassengerCount'] as num?)?.toInt(),
  specialAssistanceNotes: json['specialAssistanceNotes'] as String?,
  services:
...
Map<String, dynamic> _$LeadDtoToJson(_LeadDto instance) => <String, dynamic>{
  ...
  'specialAssistanceRequired': instance.specialAssistanceRequired,
  'assistancePassengerCount': instance.assistancePassengerCount,
  'specialAssistanceNotes': instance.specialAssistanceNotes,
